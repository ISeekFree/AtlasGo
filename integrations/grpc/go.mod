...
replace (
	github.com/ISeekFree/AtlasGo => ../..
	// grpc-go's xDS dependency graph still references the pre-split module;
	// use its post-split empty parent so it cannot overlap the api/rpc modules.
